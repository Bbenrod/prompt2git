        ...
        >
            <div className="max-w-4xl mx-auto px-4">
                <div className="flex flex-col items-center justify-center min-h-screen">
                    <header
                        className={`flex flex-col sm:flex-row sm:justify-center w-full pt-4 pb-8 px-2 text-${
                            isDarkMode ? "git-white" : "git-brown"
                        }`}
                    >
                    ...
                    >
                        <div className="w-full">
                            <form
                                className={`rounded-xl container-w-gradient-border p-3 h-full w-full shadow-md ${
                                    isDarkMode
                                        ? "bg-git-brown-d20"
                                        : "bg-git-white-20"
                                }`}
                            >
                                <div className="flex flex-col h-full">
                                    ...
                                    <textarea
                                        className={`border-0 rounded-lg w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline resize-none ${
                                            isDarkMode
                                        ...
                                        placeholder={
                                            isSwitched
                                                ? "example: git stash"
                                                : "example: Shows a detailed record of all changes"
                                        }
                                        value={inputConvert}
                                        onChange={(e) =>
                        ...
                        <div className="w-full">
                            ...
                            >
                                <div className="flex flex-col h-full">
                                    ...
                                    <textarea
                                        className={`border-0 rounded-lg w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline pointer-events-none resize-none ${
                                            isDarkMode
                                                ? "placeholder-git-white-10 bg-git-brown-d30 text-git-white-20"
                                                : "appearance-none text-gray-700"
                                        }`}
