...
export default function App() {
    return (
        <div className=' bg-gray-100 text-gray-800  font-sans transition-colors'>
            <div className='max-w-4xl mx-auto px-4'>
                <div className='flex flex-col items-center justify-center min-h-screen'>
                        ...
                        <div className='flex items-center gap-3 pt-4'>
                            <a className='rounded-full text-gray-500' href=''>
                                <div className='flex items-center justify-center space-x-2 py-2 px-6 rounded-full bg-gray-50 text-black shadow-xl text-sm font-medium'>
                                    <img src='public/github.svg' alt='Git' className='w-5 h-5' />
                                    <p>Star on Github</p>
                                </div>
                            </a>
                    ...
                    <button className='absolute top-2.5 right-2.5 text-gray-500 focus:outline-none hover:scale-125 transition w-4 h-4'>
                        <img class='w-4 h-4' src='public/moon.svg'></img>
                    </button>
                    <div className='flex flex-col md:flex-row w-full gap-6 bg-[#EEEEEE] rounded-2xl p-2'>
                        <div className='w-full'>
                            <form className='rounded-xl bg-white container-w-gradient-border p-3 h-full w-full'>
                                <div className='flex flex-col h-full'>
                                    <label for='inputText' className='block font-medium mb-2 text-gray-700'>
                                        Lenguaje Humano
                                    </label>
                                    <textarea className='appearance-none border-0 rounded-lg w-full py-2 px-3 bg-gray-50 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' id='inputPrompt' rows={3} placeholder='Ingresa tu prompt'></textarea>
                        ...
                        <div>
                            <div className='flex items-center md:h-full'>
                                <button className='text-gray-700 cursor-pointer mx-auto'>
                                    <img src='public/refresh.svg' alt='Switch' className='w-8 h-8 md:w-16 md:h-16'></img>
                                </button>
                            </div>
                        </div>
                        <div className='w-full'>
                            <form className='rounded-xl bg-white container-w-gradient-border p-3 h-full w-full'>
                                    <div className='flex flex-col h-full'>
                                        ...
                                        <textarea className='appearance-none border-0 rounded-lg w-full py-2 px-3 bg-gray-50 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' id='inputGit' rows={3} placeholder='Ingresa tu prompt'></textarea>
                                        <div className='flex items-center justify-between my-3 last:mb-0 space-x-10'>
                                            <button type='submit' className='cursor-pointer py-2 px-4 bg-gray-100 rounded-full shadow-2xl flex flex-row'>
                                                <div className='relative text-sm font-semibold font-inter text-white text-center inline-block mx-auto'>
                                                    <img className='h-5 w-5' src='public/copy.svg' alt='Copy'/>
                                                </div>
                                            </button>
                                        </div>
                                    </div>
